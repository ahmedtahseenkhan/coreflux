...
const ITEMS: WorkItem[] = [
  { tag: "LMS / EdTech", title: "Empowered Learnings — interactive learning platform", meta: "Live · Realtime classes · Whiteboard", href: "https://emplearnings.com/", live: true },
      ...
      <div className="wrap">
        ...
        <div className="reveal grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {ITEMS.map((it, i) => {
            ...
            const cls =
              "group relative flex flex-col min-h-[260px] p-7 bg-white rounded-[16px] border border-[color:var(--line)] shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1";
